...
["_main","_accept","_memory","___indirect_function_table","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'app-module.wasm';
...
// end include: preamble.js
  ...
  function _app_read_from_socket(writePtr, maxBytesToWrite) {
          try {
  ...
  function _app_write_to_socket(readPtr) {
          try {
              const wasmSocket = window['__APP_WASM_SOCKET__'];
              if(wasmSocket) {
...
var wasmImports = {
  ...
  app_read_from_socket: _app_read_from_socket,
  app_write_to_socket: _app_write_to_socket,
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = whenAppModuleReady;
else if (typeof define === 'function' && define['amd'])
  define([], () => whenAppModuleReady);
